...
// const { registerUser, badRegisterUserRequest, passwordReset, badPasswordReset,passwordVerify } = require("../dummyData");
...
//     this.beforeAll(async function(){
//       this.timeout(0)
//       res = await chai.request(server).post("v1/reset-password").send(badPasswordReset)
//     })
//     it("User cannot send incomplete data", async function (){
//     })
